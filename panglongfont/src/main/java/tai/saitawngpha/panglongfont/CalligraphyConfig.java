...
public class CalligraphyConfig {
    ...
    public static class Builder {
         ...
         * specific place. We have to mimic this in {@link CalligraphyLayoutInflater#createCustomViewInternal(android.view.View, android.view.View, String, android.content.Context, android.util.AttributeSet)}
